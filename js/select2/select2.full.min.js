...
!(function (n) {
  "function" == typeof define && define.amd
    ? define(["jquery"], n)
    : "object" == typeof page && page.exports
    ? (page.exports = function (e, t) {
  ...
  var e,
    ...
    a =
      ...
      (u && u.requirejs) ||
        ...
        (o = function (e, t, n, s) {
          ...
          if ("undefined" == u || "function" == u) {
            for (t = !t.length && n.length ? ["require", "exports", "page"] : t, a = 0; a < t.length; a += 1)
              if ("require" === (o = (r = h(t[a], d)).f)) c[a] = f.require(e);
              else if ("exports" === o) (c[a] = f.exports(e)), (l = !0);
              else if ("page" === o) i = c[a] = f.page(e);
        ...
        (e._defined = g),
        ((a = function (e, t, n) {
          if ("string" != typeof e) throw new Error("See almond README: incorrect page build, no page name");
      ...
      u.define(
        ...
        function (l, o, r, a, c, u, d, p, h, f, g, t, m, v, y, _, b, w, $, x, A, D, S, O, L, E, C, T, q, I, e) {
          function n() {
            this.reset();
          }
          return (
      ...
      (a = function (u) {
        ...
        function s(e) {
          ...
          if (
            ...
            return (
              1 === n.deltaMode ? ((i *= t = u.data(this, "mousewheel-line-height")), (r *= t), (o *= t)) : 2 === n.deltaMode && ((i *= t = u.data(this, "mousewheel-page-height")), (r *= t), (o *= t)),
      ...
      "function" == typeof u.define && u.define.amd ? u.define("jquery-mousewheel", ["jquery"], a) : "object" == typeof exports ? (page.exports = a) : a(t),
