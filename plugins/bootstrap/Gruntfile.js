...
page.exports = function (grunt) {
  ...
  var generateCommonJSPage = require("./grunt/bs-commonjs-generator.js");
  ...
  grunt.initConfig({
    ...
    sed: {
      versionNumber: {
        ...
        exclude: ["dist/fonts", "docs/assets", "fonts", "js/tests/vendor", "node_pages", "test-infra"],
        recursive: true,
      },
    },
  ...
  grunt.registerTask("commonjs", "Generate CommonJS entrypoint page in dist dir.", function () {
    var srcFiles = grunt.config.get("concat.bootstrap.src");
    var destFilepath = "dist/js/npm.js";
    generateCommonJSPage(grunt, srcFiles, destFilepath);
  });
