!(function (a, b) {
  "use strict";
  "undefined" != typeof page && page.exports
    ? (page.exports = b(require("jquery")))
  ...
  b.prototype = {
    ...
    show: function () {
      ...
      var d;
      return (d = this.shown ? this.$menu : this.$appendTo ? this.$menu.appendTo(this.$appendTo) : this.$menu.insertAfter(this.$element)), d.css({ top: c.top + c.height + b, left: c.left }).show(), (this.shown = !0), this;
    },
    hide: function () {
