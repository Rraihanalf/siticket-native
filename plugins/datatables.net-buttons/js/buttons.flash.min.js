(function (g) {
  "function" === typeof define && define.amd
    ? define(["jquery", "datatables.net", "datatables.net-buttons"], function (i) {
        return g(i, window, document);
      })
    : "object" === typeof exports
    ? (page.exports = function (i, k) {
        i || (i = window);
  ...
  j.ext.buttons.copyFlash = g.extend({}, s, {
    ...
    action: function (a, b, d, c) {
      c._fromFlash &&
        ...
        a.setAction("copy"),
        r(a, c),
        b.buttons.info(b.i18n("buttons.copyTitle", "Copy to clipboard"), b.i18n("buttons.copySuccess", { _: "Copied %d rows to clipboard", 1: "Copied 1 row to clipboard" }, d.rows), 3e3));
    },
    fieldSeparator: "\t",
    fieldBoundary: "",
  });
    ...
    action: function (a, b, d, c) {
      var a = c._flash,
        ...
        d = {
          ...
          xl: { _rels: { "workbook.xml.rels": g.parseXML(p["xl/_rels/workbook.xml.rels"]) }, "workbook.xml": g.parseXML(p["xl/workbook.xml"]), "styles.xml": g.parseXML(p["xl/styles.xml"]), worksheets: { "sheet1.xml": f } },
        ...
        j = function (a) {
          ...
          for (var b = 0, c = a.length; b < c; b++) {
            ...
            "number" === typeof a[b] || (a[b].match && g.trim(a[b]).match(/^-?\d+(\.\d+)?$/) && !g.trim(a[b]).match(/^0\d+/))
              ? (d = l(f, "c", { attr: { t: "n", r: d }, children: [l(f, "v", { text: a[b] })] }))
              : ((j = !a[b].replace
                  ? a[b]
                  : a[b]
                      .replace(/&(?!amp;)/g, "&amp;")
                ...
                (d = l(f, "c", { attr: { t: "inlineStr", r: d }, children: { row: l(f, "is", { children: { row: l(f, "t", { text: j }) } }) } })));
            k.appendChild(d);
          }
          h.appendChild(k);
          e++;
      ...
      m = 0;
      for (n = b.header.length; m < n; m++) j.appendChild(l(f, "col", { attr: { min: m + 1, max: m + 1, width: y(b, m), customWidth: 1 } }));
  ...
  j.ext.buttons.pdfFlash = g.extend({}, s, {
    ...
    action: function (a, b, d, c) {
      ...
      a.setAction("pdf");
      a.setFileName(q(c));
      r(a, JSON.stringify({ title: q(c, !1), message: c.message, colWidth: f.toArray(), orientation: c.orientation, size: c.pageSize, header: c.header ? d.header : null, footer: c.footer ? d.footer : null, body: d.body }));
    },
    extension: ".pdf",
