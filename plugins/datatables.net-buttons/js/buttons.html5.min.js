(function (g) {
  ...
  function E(a, b) {
    ...
    g.each(b, function (b, c) {
      if (g.isPlainObject(c)) {
        ...
        v && (-1 === e.indexOf("<?xml") && (e = '<?xml version="1.0" encoding="UTF-8" standalone="yes"?>' + e), (e = e.replace(/_dt_b_namespace_token_/g, ":")));
  ...
  s.ext.buttons.excelHtml5 = {
    ...
    action: function (a, b, d, c) {
      var e = 0,
        ...
        d = function (a) {
          ...
          for (var b = 0, c = a.length; b < c; b++) {
            ...
            if (typeof a[b] === "number" || (a[b].match && g.trim(a[b]).match(/^-?\d+(\.\d+)?$/) && !g.trim(a[b]).match(/^0\d+/))) d = o(f, "c", { attr: { t: "n", r: d }, children: [o(f, "v", { text: a[b] })] });
            else {
              i = !a[b].replace
                ? a[b]
                : a[b]
      ...
      i = 0;
      for (l = b.header.length; i < l; i++) d.appendChild(o(f, "col", { attr: { min: i + 1, max: i + 1, width: N(b, i), customWidth: 1 } }));
