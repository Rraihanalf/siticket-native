...
(function (d) {
  ...
  var j = d.fn.dataTable,
    ...
    i = function (b, a) {
      ...
      this.s = {
        dt: b,
        position: { theadTop: 0, tbodyTop: 0, tfootTop: 0, tfootBottom: 0, width: 0, left: 0, tfootHeight: 0, theadHeight: 0, windowHeight: d(g).height(), visible: !0 },
        headerMode: null,
        footerMode: null,
  ...
  d.extend(i.prototype, {
    ...
    _positions: function () {
      ...
      f.length
        ? ((a.tfootTop = f.offset().top), (a.tfootBottom = a.tfootTop + f.outerHeight()), (a.tfootHeight = a.tfootBottom - a.tfootTop))
    ...
    _scroll: function (b) {
      ...
      if (
        this.s.enable &&
        (this.c.header &&
          ((f = !c.visible || a <= c.theadTop - this.c.headerOffset ? "in-place" : a <= c.tfootTop - c.theadHeight - this.c.headerOffset ? "in" : "below"),
