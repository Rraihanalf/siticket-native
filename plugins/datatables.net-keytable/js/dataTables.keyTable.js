    ...
    _constructor: function () {
      ...
      if (dt.settings()[0].oFeatures.bStateSave) {
        dt.on("stateSaveParams.keyTable", function (e, s, d) {
          d.keyTable = that.s.lastFocus ? that.s.lastFocus.index() : null;
        });
      }
      ...
      dt.on("destroy.keyTable", function () {
        ...
        $(document.body).off("keydown.keyTable").off("click.keyTable");
      });
      ...
      switch (e.keyCode) {
        ...
        case 34: // page down (next page)
          ...
          dt.one("draw", function () {
            ...
            that._focus(dt.cell(index < nodes.length ? nodes[index] : nodes[nodes.length - 1]));
          })
        ...
        case 36: // home (start of current page)
          ...
          this._focus(dt.cell(indexes[e.keyCode === 35 ? indexes.length - 1 : 0]));
          break;
