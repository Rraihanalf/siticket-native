  ...
  c.extend(j.prototype, {
    ...
    _detailsObj: function (a) {
      ...
      return c.map(this.s.columns, function (e, c) {
        if (!e.never && !e.control) return { title: d.settings()[0].aoColumns[c].sTitle, data: d.cell(a, c).render(b.c.orthogonal), hidden: d.column(c).visible() && !b.s.current[c], columnIndex: c, rowIndex: a };
      });
    },
    _find: function (a) {
    ...
    _tabIndexes: function () {
      ...
      c("number" === typeof e ? ":eq(" + e + ")" : e, a.rows({ page: "current" }).nodes())
            ...
            g = c('<div class="dtr-modal"/>')
              .append(
                c('<div class="dtr-modal-display"/>')
                  ...
                  .append(
                    c('<div class="dtr-modal-close">&times;</div>').click(function () {
                      f();
                    })
                  )
              )
    ...
    listHidden: function () {
      return function (a, b, d) {
        return (a = c
          .map(d, function (a) {
            return a.hidden
              ? '<li data-dtr-index="' + a.columnIndex + '" data-dt-row="' + a.rowIndex + '" data-dt-column="' + a.columnIndex + '"><span class="dtr-title">' + a.title + '</span> <span class="dtr-data">' + a.data + "</span></li>"
              : "";
          })
          .join(""))
