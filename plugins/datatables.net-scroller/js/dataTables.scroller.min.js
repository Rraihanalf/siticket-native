...
(function (e) {
    ...
    g = function (a, b) {
      this instanceof g
        ? (b === l && (b = {}),
          ...
          (this.dom = { force: j.createElement("div"), scroller: null, table: null, loader: null }),
  ...
  e.extend(g.prototype, {
    ...
    _fnConstruct: function () {
      ...
      if (this.s.dt.oFeatures.bPaginate) {
        ...
        this.s.loadingIndicator &&
          ((this.dom.loader = e('<div class="dataTables_processing DTS_Loading">' + this.s.dt.oLanguage.sLoadingRecords + "</div>").css("display", "none")),
        ...
        if (this.s.dt.bFiltered || this.s.dt.bSorted) this.s.lastScrollTop = 0;
          ...
          if (c < this.s.redrawTop || c > this.s.redrawBottom) {
            ...
            Math.abs(c - this.s.lastScrollTop) > b.viewport || this.s.ani
              ? ((d = parseInt(this._domain("physicalToVirtual", c) / b.row, 10) - f), (this.s.topRowFloat = this._domain("physicalToVirtual", c) / b.row))
    ...
    _fnDrawCallback: function () {
      ...
      this.s.skip = !0;
      this._fnScrollForce();
      c = 0 === f ? this.s.topRowFloat * b.row : f + i >= g ? b.scroll - (g - this.s.topRowFloat) * b.row : this._domain("virtualToPhysical", this.s.topRowFloat * b.row);
      ...
      this.s.dt.oFeatures.bStateSave && null !== this.s.dt.oLoadedState && "undefined" != typeof this.s.dt.oLoadedState.iScroller
        ? (((c = (this.s.dt.sAjaxSource || a.s.dt.ajax) && !this.s.dt.oFeatures.bServerSide ? !0 : !1) && 2 == this.s.dt.iDraw) || (!c && 1 == this.s.dt.iDraw)) &&
          setTimeout(function () {
        ...
        var a = this.s.dt,
          ...
          g =
            0 === a.fnRecordsDisplay() && a.fnRecordsDisplay() == a.fnRecordsTotal()
              ...
              ? b.sInfoEmpty + " " + b.sInfoFiltered.replace("_MAX_", j) + b.sInfoPostFix
              : a.fnRecordsDisplay() == a.fnRecordsTotal()
              ? b.sInfo.replace("_START_", g).replace("_END_", h).replace("_MAX_", j).replace("_TOTAL_", k) + b.sInfoPostFix
              : b.sInfo.replace("_START_", g).replace("_END_", h).replace("_MAX_", j).replace("_TOTAL_", k) + " " + b.sInfoFiltered.replace("_MAX_", a.fnFormatNumber(a.fnRecordsTotal())) + b.sInfoPostFix;
  ...
  g.version = "1.4.2";
  "function" == typeof e.fn.dataTable && "function" == typeof e.fn.dataTableExt.fnVersionCheck && e.fn.dataTableExt.fnVersionCheck("1.10.0")
