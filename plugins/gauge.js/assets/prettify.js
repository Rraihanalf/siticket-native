...
(function () {
  ...
  var v = ["break,continue,do,else,for,if,return,while"],
    ...
    J = [v, "alias,and,begin,case,class,def,defined,elsif,end,ensure,false,in,page,next,nil,not,or,redo,rescue,retry,self,super,then,true,undef,unless,until,when,yield,BEGIN,END"],
