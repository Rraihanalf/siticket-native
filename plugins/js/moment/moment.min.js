...
(function (a) {
  ...
  function u(a, b) {
    return function (c, d) {
      var e, f;
      return (
        null === d || isNaN(+d) || (g(b, "moment()." + b + "(period, number) is deprecated. Please use moment()." + b + "(number, period)."), (f = c), (c = d), (d = f)),
  ...
  function U(a) {
    ...
    (c = a._w),
      null != c.GG || null != c.W || null != c.E
        ...
        : ((g = a._locale._week.dow), (h = a._locale._week.doy), (d = b(c.gg, a._a[Cb], jb(vb(), g, h).year)), (e = b(c.w, 1)), null != c.d ? ((f = c.d), g > f && ++e) : (f = null != c.e ? c.e + g : g)),
      (i = kb(d, e, f, h, g)),
      (a._a[Cb] = i.year),
    ...
    if (!a._d) {
      for (
        e = X(a),
          ...
          a._dayOfYear && ((f = b(a._a[Cb], e[Cb])), a._dayOfYear > F(f) && (a._pf._overflowDayOfYear = !0), (d = fb(f, 0, a._dayOfYear)), (a._a[Db] = d.getUTCMonth()), (a._a[Eb] = d.getUTCDate())),
          c = 0;
        3 > c && null == a._a[c];
        ++c
      )
  ...
  for (
    var vb,
      ...
      Jb = {},
      Kb = [],
      Lb = "undefined" != typeof page && page && page.exports,
      Mb = /^\/?Date\((\-?\d+)/i,
      Nb = /(\-)?(?:(\d*)\.)?(\d+)\:(\d+)(?:\:(\d+)\.?(\d{3})?)?/,
      ...
      jc = /([\+\-]|\d\d)/gi,
      kc = ("Date|Hours|Minutes|Seconds|Milliseconds".split("|"), { Milliseconds: 1, Seconds: 1e3, Minutes: 6e4, Hours: 36e5, Days: 864e5, Months: 2592e6, Years: 31536e6 }),
      lc = { ms: "millisecond", s: "second", m: "minute", h: "hour", d: "day", D: "date", w: "week", W: "isoWeek", M: "month", Q: "quarter", y: "year", DDD: "dayOfYear", e: "weekday", E: "isoWeekday", gg: "weekYear", GG: "isoWeekYear" },
      mc = { dayofyear: "dayOfYear", isoweekday: "isoWeekday", isoweek: "isoWeek", weekyear: "weekYear", isoweekyear: "isoWeekYear" },
      nc = {},
    ...
    o(l.prototype, {
      ...
      weekdaysParse: function (a) {
        ...
        for (this._weekdaysParse || (this._weekdaysParse = []), b = 0; 7 > b; b++)
          if (
            (this._weekdaysParse[b] || ((c = vb([2e3, 1]).day(b)), (d = "^" + this.weekdays(c, "") + "|^" + this.weekdaysShort(c, "") + "|^" + this.weekdaysMin(c, "")), (this._weekdaysParse[b] = new RegExp(d.replace(".", ""), "i"))),
    ...
    (vb.duration = function (a, b) {
      ...
      return (
        vb.isDuration(a)
          ...
          : (i = Nb.exec(a))
          ? ((d = "-" === i[1] ? -1 : 1), (h = { y: 0, d: C(i[Eb]) * d, h: C(i[Fb]) * d, m: C(i[Gb]) * d, s: C(i[Hb]) * d, ms: C(i[Ib]) * d }))
          : (i = Ob.exec(a))
          ? ((d = "-" === i[1] ? -1 : 1),
            (f = function (a) {
      ...
      diff: function (a, b, c) {
        ...
        return (
          ...
          "year" === b || "month" === b || "quarter" === b
            ...
            : ((d = this - f), (e = "second" === b ? d / 1e3 : "minute" === b ? d / 6e4 : "hour" === b ? d / 36e5 : "day" === b ? (d - g) / 864e5 : "week" === b ? (d - g) / 6048e5 : d)),
          c ? e : q(e)
        );
      },
      from: function (a, b) {
      ...
      utcOffset: function (a, b) {
        ...
        return null != a
          ? ("string" == typeof a && (a = S(a)),
            ...
            (this._isUTC = !0),
            null != c && this.add(c, "m"),
            d !== a && (!b || this._changeInProgress ? v(this, vb.duration(a - d, "m"), 1, !1) : this._changeInProgress || ((this._changeInProgress = !0), vb.updateOffset(this, !0), (this._changeInProgress = null))),
            this)
          : this._isUTC
          ? d
          : this._dateUtcOffset();
