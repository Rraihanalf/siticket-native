!(function (a, b) {
  "object" == typeof exports && "undefined" != typeof page && "function" == typeof require ? b(require("../moment")) : "function" == typeof define && define.amd ? define(["moment"], b) : b(a.moment);
})(this, function (a) {
  "use strict";
  ...
  var _ =
    ...
    aa = { "١": "1", "٢": "2", "٣": "3", "٤": "4", "٥": "5", "٦": "6", "٧": "7", "٨": "8", "٩": "9", "٠": "0" },
    ba =
      ...
      { 1: "١", 2: "٢", 3: "٣", 4: "٤", 5: "٥", 6: "٦", 7: "٧", 8: "٨", 9: "٩", 0: "٠" }),
    ca = { "١": "1", "٢": "2", "٣": "3", "٤": "4", "٥": "5", "٦": "6", "٧": "7", "٨": "8", "٩": "9", "٠": "0" },
    da = function (a) {
    ...
    ha =
      (a.defineLocale("ar", {
        ...
        relativeTime: { future: "بعد %s", past: "منذ %s", s: fa("s"), m: fa("m"), mm: fa("m"), h: fa("h"), hh: fa("h"), d: fa("d"), dd: fa("d"), M: fa("M"), MM: fa("M"), y: fa("y"), yy: fa("y") },
        preparse: function (a) {
          return a
            .replace(/\u200f/g, "")
            .replace(/[١٢٣٤٥٦٧٨٩٠]/g, function (a) {
    ...
    ia =
      ...
      a.defineLocale("be", {
        ...
        relativeTime: { future: "праз %s", past: "%s таму", s: "некалькі секунд", m: c, mm: c, h: c, hh: c, d: "дзень", dd: c, M: "месяц", MM: c, y: "год", yy: c },
    ...
    ja = { "১": "1", "২": "2", "৩": "3", "৪": "4", "৫": "5", "৬": "6", "৭": "7", "৮": "8", "৯": "9", "০": "0" },
    ka =
      (a.defineLocale("bn", {
    ...
    la = { "༡": "1", "༢": "2", "༣": "3", "༤": "4", "༥": "5", "༦": "6", "༧": "7", "༨": "8", "༩": "9", "༠": "0" },
    ma =
      (a.defineLocale("bo", {
      ...
      a.defineLocale("br", {
        ...
        relativeTime: { future: "a-benn %s", past: "%s 'zo", s: "un nebeud segondennoù", m: "ur vunutenn", mm: d, h: "un eur", hh: "%d eur", d: "un devezh", dd: d, M: "ur miz", MM: d, y: "ur bloaz", yy: e },
      ...
      a.defineLocale("bs", {
        ...
        relativeTime: { future: "za %s", past: "prije %s", s: "par sekundi", m: i, mm: i, h: i, hh: i, d: "dan", dd: i, M: "mjesec", MM: i, y: "godinu", yy: i },
        ordinalParse: /\d{1,2}\./,
        ordinal: "%d.",
        week: { dow: 1, doy: 7 },
      }),
    ...
    oa =
      (a.defineLocale("cs", {
        ...
        relativeTime: { future: "za %s", past: "před %s", s: k, m: k, mm: k, h: k, hh: k, d: k, dd: k, M: k, MM: k, y: k, yy: k },
        ordinalParse: /\d{1,2}\./,
        ordinal: "%d.",
        week: { dow: 1, doy: 4 },
      }),
      ...
      a.defineLocale("de-at", {
        ...
        relativeTime: { future: "in %s", past: "vor %s", s: "ein paar Sekunden", m: l, mm: "%d Minuten", h: l, hh: "%d Stunden", d: l, dd: l, M: l, MM: l, y: l, yy: l },
        ordinalParse: /\d{1,2}\./,
        ordinal: "%d.",
        week: { dow: 1, doy: 4 },
      }),
      a.defineLocale("de", {
        ...
        longDateFormat: { LT: "HH:mm", LTS: "HH:mm:ss", L: "DD.MM.YYYY", LL: "D. MMMM YYYY", LLL: "D. MMMM YYYY HH:mm", LLLL: "dddd, D. MMMM YYYY HH:mm" },
        calendar: { sameDay: "[heute um] LT [Uhr]", sameElse: "L", nextDay: "[morgen um] LT [Uhr]", nextWeek: "dddd [um] LT [Uhr]", lastDay: "[gestern um] LT [Uhr]", lastWeek: "[letzten] dddd [um] LT [Uhr]" },
        relativeTime: { future: "in %s", past: "vor %s", s: "ein paar Sekunden", m: m, mm: "%d Minuten", h: m, hh: "%d Stunden", d: m, dd: m, M: m, MM: m, y: m, yy: m },
        ordinalParse: /\d{1,2}\./,
        ordinal: "%d.",
        week: { dow: 1, doy: 4 },
      }),
    ...
    sa =
      ...
      a.defineLocale("et", {
        ...
        relativeTime: { future: "%s pärast", past: "%s tagasi", s: o, m: o, mm: o, h: o, hh: o, d: o, dd: "%d päeva", M: o, MM: o, y: o, yy: o },
        ordinalParse: /\d{1,2}\./,
        ordinal: "%d.",
        week: { dow: 1, doy: 4 },
      }),
    ...
    ta = { "۱": "1", "۲": "2", "۳": "3", "۴": "4", "۵": "5", "۶": "6", "۷": "7", "۸": "8", "۹": "9", "۰": "0" },
    ua =
      (a.defineLocale("fa", {
    ...
    wa =
      (a.defineLocale("fi", {
        ...
        relativeTime: { future: "%s päästä", past: "%s sitten", s: p, m: p, mm: p, h: p, hh: p, d: p, dd: p, M: p, MM: p, y: p, yy: p },
        ordinalParse: /\d{1,2}\./,
        ordinal: "%d.",
        week: { dow: 1, doy: 4 },
      }),
    ...
    Ea = { "१": "1", "२": "2", "३": "3", "४": "4", "५": "5", "६": "6", "७": "7", "८": "8", "९": "9", "०": "0" },
    Fa =
      (a.defineLocale("hi", {
      ...
      a.defineLocale("hr", {
        ...
        relativeTime: { future: "za %s", past: "prije %s", s: "par sekundi", m: r, mm: r, h: r, hh: r, d: "dan", dd: r, M: "mjesec", MM: r, y: "godinu", yy: r },
        ordinalParse: /\d{1,2}\./,
        ordinal: "%d.",
        week: { dow: 1, doy: 7 },
      }),
    ...
    Ga =
      (a.defineLocale("hu", {
        ...
        relativeTime: { future: "%s múlva", past: "%s", s: s, m: s, mm: s, h: s, hh: s, d: s, dd: s, M: s, MM: s, y: s, yy: s },
        ordinalParse: /\d{1,2}\./,
        ordinal: "%d.",
        week: { dow: 1, doy: 7 },
      }),
      ...
      a.defineLocale("is", {
        ...
        relativeTime: { future: "eftir %s", past: "fyrir %s síðan", s: v, m: v, mm: v, h: "klukkustund", hh: v, d: v, dd: v, M: v, MM: v, y: v, yy: v },
        ordinalParse: /\d{1,2}\./,
        ordinal: "%d.",
        week: { dow: 1, doy: 4 },
      }),
    ...
    Ia =
      ...
      a.defineLocale("lb", {
        ...
        relativeTime: { future: x, past: y, s: "e puer Sekonnen", m: w, mm: "%d Minutten", h: w, hh: "%d Stonnen", d: w, dd: "%d Deeg", M: w, MM: "%d Méint", y: w, yy: "%d Joer" },
        ordinalParse: /\d{1,2}\./,
        ordinal: "%d.",
        week: { dow: 1, doy: 4 },
      }),
    ...
    Ja =
      (a.defineLocale("lt", {
        ...
        relativeTime: { future: "po %s", past: "prieš %s", s: A, m: B, mm: E, h: B, hh: E, d: B, dd: E, M: B, MM: E, y: B, yy: E },
    ...
    Ka =
      (a.defineLocale("lv", {
        ...
        relativeTime: { future: "pēc %s", past: "pirms %s", s: I, m: H, mm: G, h: H, hh: G, d: H, dd: G, M: H, MM: G, y: H, yy: G },
        ordinalParse: /\d{1,2}\./,
        ordinal: "%d.",
        week: { dow: 1, doy: 4 },
      }),
    ...
    La =
      ...
      { 1: "१", 2: "२", 3: "३", 4: "४", 5: "५", 6: "६", 7: "७", 8: "८", 9: "९", 0: "०" }),
    Ma = { "१": "1", "२": "2", "३": "3", "४": "4", "५": "5", "६": "6", "७": "7", "८": "8", "९": "9", "०": "0" },
    Na =
      (a.defineLocale("mr", {
        ...
        relativeTime: { future: "%sमध्ये", past: "%sपूर्वी", s: J, m: J, mm: J, h: J, hh: J, d: J, dd: J, M: J, MM: J, y: J, yy: J },
        preparse: function (a) {
          return a.replace(/[१२३४५६७८९०]/g, function (a) {
            return Ma[a];
          });
    ...
    Oa = { "၁": "1", "၂": "2", "၃": "3", "၄": "4", "၅": "5", "၆": "6", "၇": "7", "၈": "8", "၉": "9", "၀": "0" },
    Pa =
      (a.defineLocale("my", {
      ...
      { 1: "१", 2: "२", 3: "३", 4: "४", 5: "५", 6: "६", 7: "७", 8: "८", 9: "९", 0: "०" }),
    Qa = { "१": "1", "२": "2", "३": "3", "४": "4", "५": "5", "६": "6", "७": "7", "८": "8", "९": "9", "०": "0" },
    Ra =
      (a.defineLocale("ne", {
    ...
    Xa =
      (a.defineLocale("pl", {
        ...
        relativeTime: { future: "za %s", past: "%s temu", s: "kilka sekund", m: L, mm: L, h: L, hh: L, d: "1 dzień", dd: "%d dni", M: "miesiąc", MM: L, y: "rok", yy: L },
        ordinalParse: /\d{1,2}\./,
        ordinal: "%d.",
        week: { dow: 1, doy: 4 },
      }),
      ...
      a.defineLocale("ro", {
        ...
        relativeTime: { future: "peste %s", past: "%s în urmă", s: "câteva secunde", m: "un minut", mm: M, h: "o oră", hh: M, d: "o zi", dd: M, M: "o lună", MM: M, y: "un an", yy: M },
        week: { dow: 1, doy: 7 },
      }),
    ...
    Ya =
      (a.defineLocale("ru", {
        ...
        relativeTime: { future: "через %s", past: "%s назад", s: "несколько секунд", m: O, mm: O, h: "час", hh: O, d: "день", dd: O, M: "месяц", MM: O, y: "год", yy: O },
    ...
    $a =
      (a.defineLocale("sk", {
        ...
        relativeTime: { future: "za %s", past: "pred %s", s: Q, m: Q, mm: Q, h: Q, hh: Q, d: Q, dd: Q, M: Q, MM: Q, y: Q, yy: Q },
        ordinalParse: /\d{1,2}\./,
        ordinal: "%d.",
        week: { dow: 1, doy: 4 },
      }),
      a.defineLocale("sl", {
        ...
        relativeTime: { future: "čez %s", past: "pred %s", s: R, m: R, mm: R, h: R, hh: R, d: R, dd: R, M: R, MM: R, y: R, yy: R },
        ordinalParse: /\d{1,2}\./,
        ordinal: "%d.",
        week: { dow: 1, doy: 7 },
      }),
    ...
    _a =
      (a.defineLocale("sr-cyrl", {
        ...
        relativeTime: { future: "за %s", past: "пре %s", s: "неколико секунди", m: $a.translate, mm: $a.translate, h: $a.translate, hh: $a.translate, d: "дан", dd: $a.translate, M: "месец", MM: $a.translate, y: "годину", yy: $a.translate },
        ordinalParse: /\d{1,2}\./,
        ordinal: "%d.",
        week: { dow: 1, doy: 7 },
      }),
    ...
    ab =
      (a.defineLocale("sr", {
        ...
        relativeTime: { future: "za %s", past: "pre %s", s: "nekoliko sekundi", m: _a.translate, mm: _a.translate, h: _a.translate, hh: _a.translate, d: "dan", dd: _a.translate, M: "mesec", MM: _a.translate, y: "godinu", yy: _a.translate },
        ordinalParse: /\d{1,2}\./,
        ordinal: "%d.",
        week: { dow: 1, doy: 7 },
      }),
    ...
    bb = { "௧": "1", "௨": "2", "௩": "3", "௪": "4", "௫": "5", "௬": "6", "௭": "7", "௮": "8", "௯": "9", "௦": "0" },
    cb =
      (a.defineLocale("ta", {
    ...
    db =
      (a.defineLocale("tlh", {
        ...
        relativeTime: { future: S, past: T, s: "puS lup", m: "wa’ tup", mm: U, h: "wa’ rep", hh: U, d: "wa’ jaj", dd: U, M: "wa’ jar", MM: U, y: "wa’ DIS", yy: U },
        ordinalParse: /\d{1,2}\./,
        ordinal: "%d.",
        week: { dow: 1, doy: 4 },
      }),
  ...
  a.defineLocale("tr", {
    ...
    a.defineLocale("tzl", {
      ...
      relativeTime: { future: "osprei %s", past: "ja%s", s: W, m: W, mm: W, h: W, hh: W, d: W, dd: W, M: W, MM: W, y: W, yy: W },
      ordinalParse: /\d{1,2}\./,
      ordinal: "%d.",
      week: { dow: 1, doy: 4 },
    }),
    ...
    a.defineLocale("uk", {
      ...
      relativeTime: { future: "за %s", past: "%s тому", s: "декілька секунд", m: Y, mm: Y, h: "годину", hh: Y, d: "день", dd: Y, M: "місяць", MM: Y, y: "рік", yy: Y },
