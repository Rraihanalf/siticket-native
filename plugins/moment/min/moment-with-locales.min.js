!(function (a, b) {
  "object" == typeof exports && "undefined" != typeof page ? (page.exports = b()) : "function" == typeof define && define.amd ? define(b) : (a.moment = b());
})(this, function () {
  "use strict";
  function a() {
  ...
  function D(a) {
    var b = null;
    if (!ke[a] && "undefined" != typeof page && page && page.exports)
      try {
  ...
  function F(a, b) {
    return null !== b
      ? ((b.abbr = a),
        null != ke[a]
          ? (v("defineLocaleOverride", "use moment.updateLocale(localeName, config) to change an existing locale. moment.defineLocale(localeName, config) should only be used for creating a new locale"), (b = z(ke[a]._config, b)))
          : null != b.parentLocale && (null != ke[b.parentLocale] ? (b = z(ke[b.parentLocale]._config, b)) : v("parentLocaleUndefined", "specified parentLocale is not defined yet")),
        (ke[a] = new A(b)),
        E(a),
        ke[a])
      : (delete ke[a], null);
      ...
      c &&
        ...
        ((b =
          c[Ke] < 0 || c[Ke] > 11
            ...
            ? Le
            : c[Me] < 0 || c[Me] > 24 || (24 === c[Me] && (0 !== c[Ne] || 0 !== c[Oe] || 0 !== c[Pe]))
            ? Me
            : c[Ne] < 0 || c[Ne] > 59
            ? Ne
            : c[Oe] < 0 || c[Oe] > 59
    ...
    if (!a._d) {
      for (
        d = za(a),
          ...
          a._dayOfYear && ((e = ya(a._a[Je], d[Je])), a._dayOfYear > ra(e) && (j(a)._overflowDayOfYear = !0), (c = qa(e, 0, a._dayOfYear)), (a._a[Ke] = c.getUTCMonth()), (a._a[Le] = c.getUTCDate())),
          b = 0;
        3 > b && null == a._a[b];
        ++b
      )
      ...
      24 === a._a[Me] && 0 === a._a[Ne] && 0 === a._a[Oe] && 0 === a._a[Pe] && ((a._nextDay = !0), (a._a[Me] = 0)),
  ...
  function Ba(a) {
    ...
    (b = a._w),
      null != b.GG || null != b.W || null != b.E
        ? ((f = 1), (g = 4), (c = ya(b.GG, a._a[Je], wa(Ka(), 1, 4).year)), (d = ya(b.W, 1)), (e = ya(b.E, 1)), (1 > e || e > 7) && (i = !0))
      ...
      1 > d || d > xa(c, f, g) ? (j(a)._overflowWeeks = !0) : null != i ? (j(a)._overflowWeekday = !0) : ((h = va(c, d, e, f, g)), (a._a[Je] = h.year), (a._dayOfYear = h.dayOfYear));
  }
  function Ca(b) {
    ...
    for (e = V(b._f, b._locale).match(me) || [], c = 0; c < e.length; c++)
      (f = e[c]),
        ...
        pe[f] ? (d ? (j(b).empty = !1) : j(b).unusedTokens.push(f), aa(f, d, b)) : b._strict && !d && j(b).unusedTokens.push(f);
    (j(b).charsLeftOver = i - k),
      h.length > 0 && j(b).unusedInput.push(h),
      j(b).bigHour === !0 && b._a[Me] <= 12 && b._a[Me] > 0 && (j(b).bigHour = void 0),
  ...
  function Ha(a) {
    ...
    return (
      ...
      null === b || (void 0 === e && "" === b) ? l({ nullInput: !0 }) : ("string" == typeof b && (a._i = b = a._locale.preparse(b)), p(b) ? new o(ma(b)) : (c(e) ? Ea(a) : e ? Ca(a) : d(b) ? (a._d = b) : Ia(a), k(a) || (a._d = null), a))
    );
  }
  function Ia(b) {
    var f = b._i;
  ...
  function Ua(b, c) {
    ...
    return this.isValid()
      ? null != b
        ? ("string" == typeof b ? (b = Ra(Ee, b)) : Math.abs(b) < 16 && (b = 60 * b),
          !this._isUTC && c && (d = Ta(this)),
          (this._offset = b),
          (this._isUTC = !0),
          null != d && this.add(d, "m"),
          e !== b && (!c || this._changeInProgress ? jb(this, db(b - e, "m"), 1, !1) : this._changeInProgress || ((this._changeInProgress = !0), a.updateOffset(this, !0), (this._changeInProgress = null))),
          this)
        : this._isUTC
        ? e
        : Ta(this)
  ...
  function db(a, b) {
    ...
    return (
      Pa(a)
        ...
        : (h = gf.exec(a))
        ? ((c = "-" === h[1] ? -1 : 1), (g = { y: 0, d: r(h[Le]) * c, h: r(h[Me]) * c, m: r(h[Ne]) * c, s: r(h[Oe]) * c, ms: r(h[Pe]) * c }))
        : (h = hf.exec(a))
        ? ((c = "-" === h[1] ? -1 : 1), (g = { y: eb(h[2], c), M: eb(h[3], c), w: eb(h[4], c), d: eb(h[5], c), h: eb(h[6], c), m: eb(h[7], c), s: eb(h[8], c) }))
        : null == g
        ? (g = {})
        : "object" == typeof g && ("from" in g || "to" in g) && ((e = gb(Ka(g.from), Ka(g.to))), (g = {}), (g.ms = e.milliseconds), (g.M = e.months)),
      (d = new Oa(g)),
  ...
  function ib(a, b) {
    return function (c, d) {
      var e, f;
      return (
        null === d || isNaN(+d) || (v(b, "moment()." + b + "(period, number) is deprecated. Please use moment()." + b + "(number, period)."), (f = c), (c = d), (d = f)),
        ...
        d.isValid()
          ? ((e = 6e4 * (d.utcOffset() - this.utcOffset())),
            ...
            "year" === b || "month" === b || "quarter" === b
              ? ((g = tb(this, d)), "quarter" === b ? (g /= 3) : "year" === b && (g /= 12))
  ...
  function kc(a) {
    return this._weekdaysParseExact
      ? (f(this, "_weekdaysRegex") || mc.call(this), a ? this._weekdaysShortStrictRegex : this._weekdaysShortRegex)
  ...
  function Tc() {
    var a,
      ...
      i = this._data;
    return (
      (f >= 0 && g >= 0 && h >= 0) || (0 >= f && 0 >= g && 0 >= h) || ((f += 864e5 * Sc(Vc(h) + g)), (g = 0), (h = 0)),
  ...
  function gd(a, b, c) {
    var d = { mm: b ? "хвіліна_хвіліны_хвілін" : "хвіліну_хвіліны_хвілін", hh: b ? "гадзіна_гадзіны_гадзін" : "гадзіну_гадзіны_гадзін", dd: "дзень_дні_дзён", MM: "месяц_месяцы_месяцаў", yy: "год_гады_гадоў" };
  ...
  function Rd(a, b, c) {
    var d = { mm: b ? "минута_минуты_минут" : "минуту_минуты_минут", hh: "час_часа_часов", dd: "день_дня_дней", MM: "месяц_месяца_месяцев", yy: "год_года_лет" };
  ...
  function _d(a, b, c) {
    var d = { mm: b ? "хвилина_хвилини_хвилин" : "хвилину_хвилини_хвилин", hh: b ? "година_години_годин" : "годину_години_годин", dd: "день_дні_днів", MM: "місяць_місяці_місяців", yy: "рік_роки_років" };
  ...
  var Bf = Af,
    Cf = { sameDay: "[Today at] LT", nextDay: "[Tomorrow at] LT", nextWeek: "dddd [at] LT", lastDay: "[Yesterday at] LT", lastWeek: "[Last] dddd [at] LT", sameElse: "L" },
    Df = { LTS: "h:mm:ss A", LT: "h:mm A", L: "MM/DD/YYYY", LL: "MMMM D, YYYY", LLL: "MMMM D, YYYY h:mm A", LLLL: "dddd, MMMM D, YYYY h:mm A" },
    Ef = "Invalid date",
    Ff = "%d",
    Gf = /\d{1,2}/,
    Hf = { future: "in %s", past: "%s ago", s: "a few seconds", m: "a minute", mm: "%d minutes", h: "an hour", hh: "%d hours", d: "a day", dd: "%d days", M: "a month", MM: "%d months", y: "a year", yy: "%d years" },
    If = A.prototype;
  (If._calendar = Cf),
    (If.calendar = zc),
  ...
  (ag.abs = Oc),
    ...
    (ag.locale = Bb),
    (ag.localeData = Cb),
    (ag.toIsoString = u("toIsoString() is deprecated. Please use toISOString() instead (notice the capitals)", ed)),
    (ag.lang = lf),
    R("X", 0, 0, "unix"),
    R("x", 0, 0, "valueOf"),
    W("x", Ce),
  ...
  var bg = a,
    ...
    kg =
      (bg.defineLocale("ar", {
        ...
        relativeTime: { future: "بعد %s", past: "منذ %s", s: ig("s"), m: ig("m"), mm: ig("m"), h: ig("h"), hh: ig("h"), d: ig("d"), dd: ig("d"), M: ig("M"), MM: ig("M"), y: ig("y"), yy: ig("y") },
        preparse: function (a) {
          return a
            .replace(/\u200f/g, "")
            .replace(/[١٢٣٤٥٦٧٨٩٠]/g, function (a) {
    ...
    lg =
      ...
      bg.defineLocale("be", {
        ...
        relativeTime: { future: "праз %s", past: "%s таму", s: "некалькі секунд", m: gd, mm: gd, h: gd, hh: gd, d: "дзень", dd: gd, M: "месяц", MM: gd, y: "год", yy: gd },
    ...
    pg =
      ...
      bg.defineLocale("br", {
        ...
        relativeTime: { future: "a-benn %s", past: "%s 'zo", s: "un nebeud segondennoù", m: "ur vunutenn", mm: hd, h: "un eur", hh: "%d eur", d: "un devezh", dd: hd, M: "ur miz", MM: hd, y: "ur bloaz", yy: id },
      ...
      bg.defineLocale("bs", {
        ...
        relativeTime: { future: "za %s", past: "prije %s", s: "par sekundi", m: md, mm: md, h: md, hh: md, d: "dan", dd: md, M: "mjesec", MM: md, y: "godinu", yy: md },
        ordinalParse: /\d{1,2}\./,
        ordinal: "%d.",
        week: { dow: 1, doy: 7 },
      }),
      bg.defineLocale("ca", {
        ...
        relativeTime: { future: "en %s", past: "fa %s", s: "uns segons", m: "un minut", mm: "%d minuts", h: "una hora", hh: "%d hores", d: "un dia", dd: "%d dies", M: "un mes", MM: "%d mesos", y: "un any", yy: "%d anys" },
    ...
    rg =
      (bg.defineLocale("cs", {
        ...
        relativeTime: { future: "za %s", past: "před %s", s: od, m: od, mm: od, h: od, hh: od, d: od, dd: od, M: od, MM: od, y: od, yy: od },
        ordinalParse: /\d{1,2}\./,
        ordinal: "%d.",
        week: { dow: 1, doy: 4 },
      }),
      ...
      bg.defineLocale("de-at", {
        ...
        relativeTime: { future: "in %s", past: "vor %s", s: "ein paar Sekunden", m: pd, mm: "%d Minuten", h: pd, hh: "%d Stunden", d: pd, dd: pd, M: pd, MM: pd, y: pd, yy: pd },
        ordinalParse: /\d{1,2}\./,
        ordinal: "%d.",
        week: { dow: 1, doy: 4 },
      }),
      bg.defineLocale("de", {
        ...
        longDateFormat: { LT: "HH:mm", LTS: "HH:mm:ss", L: "DD.MM.YYYY", LL: "D. MMMM YYYY", LLL: "D. MMMM YYYY HH:mm", LLLL: "dddd, D. MMMM YYYY HH:mm" },
        calendar: { sameDay: "[heute um] LT [Uhr]", sameElse: "L", nextDay: "[morgen um] LT [Uhr]", nextWeek: "dddd [um] LT [Uhr]", lastDay: "[gestern um] LT [Uhr]", lastWeek: "[letzten] dddd [um] LT [Uhr]" },
        relativeTime: { future: "in %s", past: "vor %s", s: "ein paar Sekunden", m: qd, mm: "%d Minuten", h: qd, hh: "%d Stunden", d: qd, dd: qd, M: qd, MM: qd, y: qd, yy: qd },
        ordinalParse: /\d{1,2}\./,
        ordinal: "%d.",
        week: { dow: 1, doy: 4 },
      }),
    ...
    tg =
      ...
      bg.defineLocale("eo", {
        ...
        relativeTime: { future: "je %s", past: "antaŭ %s", s: "sekundoj", m: "minuto", mm: "%d minutoj", h: "horo", hh: "%d horoj", d: "tago", dd: "%d tagoj", M: "monato", MM: "%d monatoj", y: "jaro", yy: "%d jaroj" },
    ...
    vg =
      ...
      bg.defineLocale("et", {
        ...
        relativeTime: { future: "%s pärast", past: "%s tagasi", s: rd, m: rd, mm: rd, h: rd, hh: rd, d: rd, dd: "%d päeva", M: rd, MM: rd, y: rd, yy: rd },
        ordinalParse: /\d{1,2}\./,
        ordinal: "%d.",
        week: { dow: 1, doy: 4 },
      }),
    ...
    wg = { "۱": "1", "۲": "2", "۳": "3", "۴": "4", "۵": "5", "۶": "6", "۷": "7", "۸": "8", "۹": "9", "۰": "0" },
    xg =
      (bg.defineLocale("fa", {
    ...
    zg =
      (bg.defineLocale("fi", {
        ...
        relativeTime: { future: "%s päästä", past: "%s sitten", s: sd, m: sd, mm: sd, h: sd, hh: sd, d: sd, dd: sd, M: sd, MM: sd, y: sd, yy: sd },
        ordinalParse: /\d{1,2}\./,
        ordinal: "%d.",
        week: { dow: 1, doy: 4 },
      }),
    ...
    Hg = { "१": "1", "२": "2", "३": "3", "४": "4", "५": "5", "६": "6", "७": "7", "८": "8", "९": "9", "०": "0" },
    Ig =
      (bg.defineLocale("hi", {
      ...
      bg.defineLocale("hr", {
        ...
        relativeTime: { future: "za %s", past: "prije %s", s: "par sekundi", m: ud, mm: ud, h: ud, hh: ud, d: "dan", dd: ud, M: "mjesec", MM: ud, y: "godinu", yy: ud },
        ordinalParse: /\d{1,2}\./,
        ordinal: "%d.",
        week: { dow: 1, doy: 7 },
      }),
    ...
    Jg =
      (bg.defineLocale("hu", {
        ...
        relativeTime: { future: "%s múlva", past: "%s", s: vd, m: vd, mm: vd, h: vd, hh: vd, d: vd, dd: vd, M: vd, MM: vd, y: vd, yy: vd },
        ordinalParse: /\d{1,2}\./,
        ordinal: "%d.",
        week: { dow: 1, doy: 7 },
      }),
      ...
      bg.defineLocale("is", {
        ...
        relativeTime: { future: "eftir %s", past: "fyrir %s síðan", s: yd, m: yd, mm: yd, h: "klukkustund", hh: yd, d: yd, dd: yd, M: yd, MM: yd, y: yd, yy: yd },
        ordinalParse: /\d{1,2}\./,
        ordinal: "%d.",
        week: { dow: 1, doy: 4 },
      }),
    ...
    Lg =
      ...
      bg.defineLocale("lb", {
        ...
        relativeTime: { future: Ad, past: Bd, s: "e puer Sekonnen", m: zd, mm: "%d Minutten", h: zd, hh: "%d Stonnen", d: zd, dd: "%d Deeg", M: zd, MM: "%d Méint", y: zd, yy: "%d Joer" },
        ordinalParse: /\d{1,2}\./,
        ordinal: "%d.",
        week: { dow: 1, doy: 4 },
      }),
    ...
    Mg =
      (bg.defineLocale("lt", {
        ...
        relativeTime: { future: "po %s", past: "prieš %s", s: Dd, m: Ed, mm: Hd, h: Ed, hh: Hd, d: Ed, dd: Hd, M: Ed, MM: Hd, y: Ed, yy: Hd },
    ...
    Ng =
      (bg.defineLocale("lv", {
        ...
        relativeTime: { future: "pēc %s", past: "pirms %s", s: Ld, m: Kd, mm: Jd, h: Kd, hh: Jd, d: Kd, dd: Jd, M: Kd, MM: Jd, y: Kd, yy: Jd },
        ordinalParse: /\d{1,2}\./,
        ordinal: "%d.",
        week: { dow: 1, doy: 4 },
      }),
    ...
    Og =
      ...
      { 1: "१", 2: "२", 3: "३", 4: "४", 5: "५", 6: "६", 7: "७", 8: "८", 9: "९", 0: "०" }),
    Pg = { "१": "1", "२": "2", "३": "3", "४": "4", "५": "5", "६": "6", "७": "7", "८": "8", "९": "9", "०": "0" },
    Qg =
      (bg.defineLocale("mr", {
        ...
        relativeTime: { future: "%sमध्ये", past: "%sपूर्वी", s: Md, m: Md, mm: Md, h: Md, hh: Md, d: Md, dd: Md, M: Md, MM: Md, y: Md, yy: Md },
        preparse: function (a) {
          return a.replace(/[१२३४५६७८९०]/g, function (a) {
            return Pg[a];
          });
    ...
    Rg = { "၁": "1", "၂": "2", "၃": "3", "၄": "4", "၅": "5", "၆": "6", "၇": "7", "၈": "8", "၉": "9", "၀": "0" },
    Sg =
      (bg.defineLocale("my", {
    ...
    Xg = { "੧": "1", "੨": "2", "੩": "3", "੪": "4", "੫": "5", "੬": "6", "੭": "7", "੮": "8", "੯": "9", "੦": "0" },
    Yg =
    ...
    $g =
      (bg.defineLocale("pl", {
        ...
        relativeTime: { future: "za %s", past: "%s temu", s: "kilka sekund", m: Od, mm: Od, h: Od, hh: Od, d: "1 dzień", dd: "%d dni", M: "miesiąc", MM: Od, y: "rok", yy: Od },
        ordinalParse: /\d{1,2}\./,
        ordinal: "%d.",
        week: { dow: 1, doy: 4 },
      }),
      ...
      bg.defineLocale("ro", {
        ...
        relativeTime: { future: "peste %s", past: "%s în urmă", s: "câteva secunde", m: "un minut", mm: Pd, h: "o oră", hh: Pd, d: "o zi", dd: Pd, M: "o lună", MM: Pd, y: "un an", yy: Pd },
        week: { dow: 1, doy: 7 },
      }),
    ...
    _g =
      (bg.defineLocale("ru", {
        ...
        relativeTime: { future: "через %s", past: "%s назад", s: "несколько секунд", m: Rd, mm: Rd, h: "час", hh: Rd, d: "день", dd: Rd, M: "месяц", MM: Rd, y: "год", yy: Rd },
    ...
    bh =
      (bg.defineLocale("sk", {
        ...
        relativeTime: { future: "za %s", past: "pred %s", s: Td, m: Td, mm: Td, h: Td, hh: Td, d: Td, dd: Td, M: Td, MM: Td, y: Td, yy: Td },
        ordinalParse: /\d{1,2}\./,
        ordinal: "%d.",
        week: { dow: 1, doy: 4 },
      }),
      bg.defineLocale("sl", {
        ...
        relativeTime: { future: "čez %s", past: "pred %s", s: Ud, m: Ud, mm: Ud, h: Ud, hh: Ud, d: Ud, dd: Ud, M: Ud, MM: Ud, y: Ud, yy: Ud },
        ordinalParse: /\d{1,2}\./,
        ordinal: "%d.",
        week: { dow: 1, doy: 7 },
      }),
    ...
    fh =
      ...
      bg.defineLocale("th", {
        ...
        weekdaysParseExact: !0,
        longDateFormat: { LT: "H นาฬิกา m นาที", LTS: "H นาฬิกา m นาที s วินาที", L: "YYYY/MM/DD", LL: "D MMMM YYYY", LLL: "D MMMM YYYY เวลา H นาฬิกา m นาที", LLLL: "วันddddที่ D MMMM YYYY เวลา H นาฬิกา m นาที" },
    ...
    gh =
      (bg.defineLocale("tlh", {
        ...
        relativeTime: { future: Vd, past: Wd, s: "puS lup", m: "wa’ tup", mm: Xd, h: "wa’ rep", hh: Xd, d: "wa’ jaj", dd: Xd, M: "wa’ jar", MM: Xd, y: "wa’ DIS", yy: Xd },
        ordinalParse: /\d{1,2}\./,
        ordinal: "%d.",
        week: { dow: 1, doy: 4 },
      }),
    ...
    hh =
      ...
      bg.defineLocale("tzl", {
        ...
        relativeTime: { future: "osprei %s", past: "ja%s", s: Zd, m: Zd, mm: Zd, h: Zd, hh: Zd, d: Zd, dd: Zd, M: Zd, MM: Zd, y: Zd, yy: Zd },
        ordinalParse: /\d{1,2}\./,
        ordinal: "%d.",
        week: { dow: 1, doy: 4 },
      }),
      ...
      bg.defineLocale("uk", {
        ...
        relativeTime: { future: "за %s", past: "%s тому", s: "декілька секунд", m: _d, mm: _d, h: "годину", hh: _d, d: "день", dd: _d, M: "місяць", MM: _d, y: "рік", yy: _d },
