...
(function (h) {
  ...
  function Ka(a, b, c, d) {
    var e = [],
      ...
      G = function (a) {
        if (c === k || c === i)
          (j = m[i]), (h = a.innerHTML.trim()), j && j._bAttrSrc ? (N(j.mData._)(d, h), s(j.mData.sort, a), s(j.mData.type, a), s(j.mData.filter, a)) : q ? (j._setter || (j._setter = N(j.mData)), j._setter(d, h)) : (d[i] = h);
        i++;
      };
    if (f)
      for (; f; ) {
  ...
  function wb(a) {
    ...
    for (g = 0; g < c; g++)
      (n = b[g]),
        ...
        s("mDataProp_" + g, i),
        d.bFilter && (s("sSearch_" + g, m.sSearch), s("bRegex_" + g, m.bRegex), s("bSearchable_" + g, n.bSearchable)),
