...
!(function (e, t) {
  ...
  var t = [],
    ...
    w = g.document,
    c = { type: !0, src: !0, nonce: !0, noPage: !0 };
  function C(e, t, n) {
    var r,
      i,
        ...
        for (l = a[a.length - 1].ownerDocument, E.map(a, Le), c = 0; c < s; c++)
          (u = a[c]),
            pe.test(u.type || "") &&
              ...
              E.contains(l, u) &&
              (u.src && "page" !== (u.type || "").toLowerCase() ? E._evalUrl && !u.noPage && E._evalUrl(u.src, { nonce: u.nonce || u.getAttribute("nonce") }, l) : C(u.textContent.replace(Se, ""), u, l));
    }
    return n;
  }
  function Oe(e, t, n) {
